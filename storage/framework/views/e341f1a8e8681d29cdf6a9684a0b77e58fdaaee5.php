...
<div class="container containerProducts">
  ...
  <div class="col-md-12">
    ...
    <h4><strong><?php echo e($productDESCRIPTION); ?></strong></h4>
  </div>

  <div class="divfile">
    <?php if($productSIDE == '4/4'): ?>
    <form action="<?php echo e(route('cart.store', $produto)); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
  ...
  <input hidden type="text" name="prdtprice" value="<?php echo e($productPRICE); ?>" readonly>
   ...
   <input hidden type="text" name="prdtID" value="<?php echo e($productID); ?>" readonly>
    ...
    <?php endif; ?>
    <?php if($productSIDE == '4/0'): ?>
    <form action="<?php echo e(route('cart.store', $produto)); ?>"  method="post" accept-charset="utf-8" onsubmit="return validatevacio();" enctype="multipart/form-data" >
      <?php echo e(csrf_field()); ?>
