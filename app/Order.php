...
class Order extends Model
{
    ...
    {
        return $this->belongsToMany('App\Product')->withPivot(['quantity','jobtype','product_decription','colorspecuuid','imgF','imgB','optionuuid','produtcode','produtid','runsizeuuid','side','tat','Optionstring']);
    }
}
