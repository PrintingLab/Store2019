      ...
      <div class="container-fluid">
        <div class="col-sm-12 col-12 row">
          ...
          <div class=" col-sm-7 col-12 row btn_3topMovil">
            ...
            <div class="col-sm-4 col-4 paddingCero" id="telefonoMb">
            ...
            @guest
            <div class="Btn_Account col-sm-5 col-6 row">
              <div class="col-sm-2  col-2 paddingCero">
            ...
            <div class="Btn_Account col-sm-5 col-6 row">
              ...
              <div class=" col-sm-3 col-2 btnCartMb">
